...
def createTrainingDataAndClusteringObject1():
    tx_power_dBm = np.array([34.0, 22.0, 30.0, 31.0, 35.0])
...
if __name__ == '__main__':
    file = open("tx_5_pt_30_n_10_td_10000_all_dim.txt","w")
###1st iteration###--------------
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    file.write(str(0.1)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(0.2)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(0.3)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(0.4)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(0.5)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(0.6)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
