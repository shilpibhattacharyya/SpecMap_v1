...
class SpecMapClustering:
    ...
    def preprocessTrainingData(self, pca_var_ratio = 1.0):
        ...
        self.index_tuples = []
	print('self.x_indices: ', len(self.x_indices))
...
###-----------------------------------------------------------------------------------------------------------------------------------
	...
	self.gmm_min_predicted_labels = self.cur_gmm.predict(self.cur_training_matrix)
...
def createTrainingDataAndClusteringObject1():
    tx_power_dBm = np.array([40.0, 40.0, 40.0, 40.0, 40.0])
...
def iteration1():
    file = open("tx_5_pt_30_n_10_dim_0-3_all_td1.txt","w")
###1st iteration###--------------
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_10_td.png', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_10_td.png', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_10_td.png', n_rows=2)


def iteration2():
    file = open("tx_5_pt_30_n_10_dim_0-3_all_td2.txt","w")
######2nd iteration####-------------
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(25)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_100_td.png', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_100_td.png', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_100_td.png', n_rows=2)




def iteration3():
    file = open("tx_5_pt_30_n_10_dim_0-3_all_td3.txt","w")
####3rd iteration-------------###
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(50)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_1000_td.png', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_1000_td.png', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_1000_td.png', n_rows=2)



def iteration4():
    file = open("tx_5_pt_30_n_10_dim_0-3_all_td4.txt","w")
####4th iteration######-----------
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(100)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_10k_td.png', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_10k_td.png', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_10k_td.png', n_rows=2)
