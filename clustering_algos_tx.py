...
#	return  cur_bic, cur_aic, cur_ari, labels
    ...
    def runGMMClusteringII(self, n_component_list, coverience_type = 'full'):
        ...
        #low = 1 
	#high = n_component_list 
	#while kh > kl: #print('kh , kl: ', kh, kl) #mid =(kh+kl)/2
...
def createTrainingDataAndClusteringObject1():
    tx_power_dBm = np.array([40.0, 40.0])
...
def createTrainingDataAndClusteringObject2():
    tx_power_dBm = np.array([40.0, 40.0, 40.0])
...
def createTrainingDataAndClusteringObject4():
    ...
    tx_power_dBm = np.array([40.0, 40.0, 40.0, 40.0, 40.0, 40.0])
...
def iteration1():
###1st iteration###--------------
    file = open("pt_30_n_10_dim_0-3_td_1000_all_tx1.txt","w")
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    file.write(str(2)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
##--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_2_tx.eps', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_2_tx.eps', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_2_tx.eps', n_rows=2)


def iteration2():
######2nd iteration####-------------
    file = open("pt_30_n_10_dim_0-3_td_1000_all_tx2.txt","w")
...
#---#----------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(3)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_3_tx.eps', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_3_tx.eps', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_3_tx.eps', n_rows=2)
...
def iteration3():
####3rd iteration-------------###
    file = open("pt_30_n_10_dim_0-3_td_1000_all_tx3.txt","w")
...
#-------------------K-Means Clustering Experiment---------------------------------#
    ...
    print "ARI (EMII vs IEM vs KMeans): ", emii_min_ari, " ", iem_min_ari, " ", kms_ari
    print "Average Map Error (EMII vs IEM vs KMeans): ", emii_avg_map_error, " ", iem_avg_map_error, " ", kms_avg_map_error
    file.write(str(4)+","+str(kms_ari)+"," +str(iem_min_ari)+ ","+str(emii_min_ari)+ ","+str(kms_avg_map_error)+","+str(iem_avg_map_error)+ ","+str(emii_avg_map_error))
    file.close()
...
##--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_4_tx.eps', n_rows=2)
#---##---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    #print 'gsm.all_maps[i]: ',  iem_display_mapList

    #for j in iem_derived_map_indices:
    #    iem_display_mapList.append( iem_derived_maps[j] )

    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_4_tx.eps', n_rows=2)
...
#---##---------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_4_tx.eps', n_rows=2)



def iteration4():
####4th iteration######-----------
    file = open("pt_30_n_10_dim_0-3_td_1000_all_tx6.txt","w")
...
#--------display the heat maps for KMeans---------------------------
    ...
    #gsm.displayMaps(map_list = kms_display_mapList, figFilename = './plots/kmeans_5_tx.eps', n_rows=2)
#---#---------------display the heat maps for GMM IEM-----------------------
    #iem_display_mapList = []
    #for i in iem_real_map_indices:
    #    iem_display_mapList.append(gsm.all_maps[i])
    ...
    #gsm.displayMaps(map_list=iem_display_mapList, figFilename = './plots/iem_5_tx.eps', n_rows=2)
...
#------------------display the heat maps for GMM EMII-----------------------
    ...
    #gsm.displayMaps(map_list=emii_display_mapList, figFilename = './plots/emii_5_tx.eps', n_rows=2)
